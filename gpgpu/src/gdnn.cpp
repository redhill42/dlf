         ...
         const Queue& queue, Event* event)
{
    ...
    routine.DoAdd(n, x_buffer, x_offset, x_inc, y_buffer, y_offset, y_inc, z_buffer, z_offset, z_inc);
}

template void PUBLIC_API add<int16_t>(const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      Buffer<int16_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API add<int32_t>(const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      Buffer<int32_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API add<int64_t>(const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      Buffer<int64_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API add<half>   (const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      Buffer<half>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API add<float>  (const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      Buffer<float>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API add<double> (const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      Buffer<double>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API add<float2> (const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      Buffer<float2>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API add<double2>(const size_t,
         ...
         const Queue& queue, Event* event)
{
    ...
    routine.DoSub(n, x_buffer, x_offset, x_inc, y_buffer, y_offset, y_inc, z_buffer, z_offset, z_inc);
}

template void PUBLIC_API sub<int16_t>(const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      Buffer<int16_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API sub<int32_t>(const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      Buffer<int32_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API sub<int64_t>(const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      Buffer<int64_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API sub<half>   (const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      Buffer<half>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API sub<float>  (const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      Buffer<float>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API sub<double> (const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      Buffer<double>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API sub<float2> (const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      Buffer<float2>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API sub<double2>(const size_t,
                                      const Buffer<double2>&, const size_t, const size_t,
                                      const Buffer<double2>&, const size_t, const size_t,
                                      Buffer<double2>&, const size_t, const size_t,
                                      const Queue&, Event*);
         ...
         const Queue& queue, Event* event)
{
    ...
    routine.DoMul(n, x_buffer, x_offset, x_inc, y_buffer, y_offset, y_inc, z_buffer, z_offset, z_inc);
}

template void PUBLIC_API mul<int16_t>(const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      Buffer<int16_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API mul<int32_t>(const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      Buffer<int32_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API mul<int64_t>(const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      Buffer<int64_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API mul<half>   (const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      Buffer<half>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API mul<float>  (const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      Buffer<float>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API mul<double> (const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      Buffer<double>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API mul<float2> (const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      Buffer<float2>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API mul<double2>(const size_t,
                                      const Buffer<double2>&, const size_t, const size_t,
                                      const Buffer<double2>&, const size_t, const size_t,
                                      Buffer<double2>&, const size_t, const size_t,
                                      const Queue&, Event*);
         ...
         const Queue& queue, Event* event)
{
    ...
    routine.DoDiv(n, x_buffer, x_offset, x_inc, y_buffer, y_offset, y_inc, z_buffer, z_offset, z_inc);
}

template void PUBLIC_API div<int16_t>(const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      const Buffer<int16_t>&, const size_t, const size_t,
                                      Buffer<int16_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API div<int32_t>(const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      const Buffer<int32_t>&, const size_t, const size_t,
                                      Buffer<int32_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API div<int64_t>(const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      const Buffer<int64_t>&, const size_t, const size_t,
                                      Buffer<int64_t>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API div<half>   (const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      const Buffer<half>&, const size_t, const size_t,
                                      Buffer<half>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API div<float>  (const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      const Buffer<float>&, const size_t, const size_t,
                                      Buffer<float>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API div<double> (const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      const Buffer<double>&, const size_t, const size_t,
                                      Buffer<double>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API div<float2> (const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      const Buffer<float2>&, const size_t, const size_t,
                                      Buffer<float2>&, const size_t, const size_t,
                                      const Queue&, Event*);
template void PUBLIC_API div<double2>(const size_t,
                                      const Buffer<double2>&, const size_t, const size_t,
                                      const Buffer<double2>&, const size_t, const size_t,
                                      Buffer<double2>&, const size_t, const size_t,
                                      const Queue&, Event*);
         ...
         const Queue& queue, Event* event)
{
    ...
    routine.DoPow(n, x_buffer, x_offset, x_inc, y_buffer, y_offset, y_inc, z_buffer, z_offset, z_inc);
}

template void PUBLIC_API pow<half>  (const size_t,
                                     const Buffer<half>&, const size_t, const size_t,
                                     const Buffer<half>&, const size_t, const size_t,
                                     Buffer<half>&, const size_t, const size_t,
                                     const Queue&, Event*);
template void PUBLIC_API pow<float> (const size_t,
                                     const Buffer<float>&, const size_t, const size_t,
                                     const Buffer<float>&, const size_t, const size_t,
                                     Buffer<float>&, const size_t, const size_t,
                                     const Queue&, Event*);
template void PUBLIC_API pow<double>(const size_t,
                                     const Buffer<double>&, const size_t, const size_t,
                                     const Buffer<double>&, const size_t, const size_t,
                                     Buffer<double>&, const size_t, const size_t,
                                     const Queue&, Event*);
