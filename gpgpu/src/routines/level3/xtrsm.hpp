...
#ifndef GPGPU_BLAS_ROUTINES_XTRSM_H_
#define GPGPU_BLAS_ROUTINES_XTRSM_H_
...
class Xtrsm: public Xgemm<T> {
 public:
  ...
  // Constructor
  Xtrsm(const Queue &queue, Event* event, const std::string &name = "TRSM");
