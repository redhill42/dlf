...
#ifndef GPGPU_BLAS_ROUTINES_XSYR2K_H_
#define GPGPU_BLAS_ROUTINES_XSYR2K_H_
...
public:
  ...
  // Constructor
  Xsyr2k(const Queue &queue, Event* event, const std::string &name = "SYR2K");
