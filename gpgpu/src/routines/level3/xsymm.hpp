...
#ifndef GPGPU_BLAS_ROUTINES_XSYMM_H_
#define GPGPU_BLAS_ROUTINES_XSYMM_H_
...
class Xsymm: public Xgemm<T> {
 public:
  ...
  // Constructor
  Xsymm(const Queue &queue, Event* event, const std::string &name = "SYMM");
