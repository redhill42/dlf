...
#ifndef GPGPU_BLAS_ROUTINES_XTRMM_H_
#define GPGPU_BLAS_ROUTINES_XTRMM_H_
...
class Xtrmm: public Xgemm<T> {
 public:
  ...
  // Constructor
  Xtrmm(const Queue &queue, Event* event, const std::string &name = "TRMM");
