...
#ifndef GPGPU_BLAS_ROUTINES_XHERK_H_
#define GPGPU_BLAS_ROUTINES_XHERK_H_
...
class Xherk: public Routine {
 public:
  ...
  // Constructor
  Xherk(const Queue &queue, Event* event, const std::string &name = "HERK");
