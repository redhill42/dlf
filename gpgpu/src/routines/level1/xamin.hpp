...
#ifndef GPGPU_BLAS_ROUTINES_XAMIN_H_
#define GPGPU_BLAS_ROUTINES_XAMIN_H_
...
class Xamin: public Xamax<T> {
 public:
  ...
  // Constructor
  Xamin(const Queue &queue, Event* event, const std::string &name = "AMIN"):
