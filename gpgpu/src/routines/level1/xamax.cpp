...
void Xamax<T>::DoAmax(const size_t n,
  ...
  auto temp_buffer1 = context_.getTemporaryBuffer<T>(temp_size);
  auto temp_buffer2 = context_.getTemporaryBuffer<unsigned int>(temp_size);
  ...
  kernel1.setArguments(static_cast<int>(n),
                       ...
                       temp_buffer1,
                       static_cast<int>(temp_buffer1.offset()),
                       temp_buffer2,
                       static_cast<int>(temp_buffer2.offset()));
  ...
  kernel2.setArguments(temp_buffer1,
                       static_cast<int>(temp_buffer1.offset()),
                       temp_buffer2,
                       static_cast<int>(temp_buffer2.offset()),
                       imax_buffer,
                       static_cast<int>(imax_offset));
