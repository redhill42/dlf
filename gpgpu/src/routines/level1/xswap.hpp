...
#ifndef GPGPU_BLAS_ROUTINES_XSWAP_H_
#define GPGPU_BLAS_ROUTINES_XSWAP_H_
...
class Xswap: public Routine {
 public:
  ...
  // Constructor
  Xswap(const Queue &queue, Event* event, const std::string &name = "SWAP");
