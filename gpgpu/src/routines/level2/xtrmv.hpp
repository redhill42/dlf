...
#ifndef GPGPU_BLAS_ROUTINES_XTRMV_H_
#define GPGPU_BLAS_ROUTINES_XTRMV_H_
...
class Xtrmv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xtrmv(const Queue &queue, Event* event, const std::string &name = "TRMV");
