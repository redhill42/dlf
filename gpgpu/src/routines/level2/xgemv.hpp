...
#ifndef GPGPU_BLAS_ROUTINES_XGEMV_H_
#define GPGPU_BLAS_ROUTINES_XGEMV_H_
...
class Xgemv: public Routine {
 public:
  ...
  // Constructor
  Xgemv(const Queue &queue, Event* event, const std::string &name = "GEMV");
