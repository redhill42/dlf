...
#ifndef GPGPU_BLAS_ROUTINES_XHER2_H_
#define GPGPU_BLAS_ROUTINES_XHER2_H_
...
class Xher2: public Routine {
 public:
  ...
  // Constructor
  Xher2(const Queue &queue, Event* event, const std::string &name = "HER2");
