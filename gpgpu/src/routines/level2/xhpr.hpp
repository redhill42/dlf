...
#ifndef GPGPU_BLAS_ROUTINES_XHPR_H_
#define GPGPU_BLAS_ROUTINES_XHPR_H_
...
class Xhpr: public Xher<T,U> {
 public:
  ...
  // Constructor
  Xhpr(const Queue &queue, Event* event, const std::string &name = "HPR");
