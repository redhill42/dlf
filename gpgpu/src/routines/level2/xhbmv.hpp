...
#ifndef GPGPU_BLAS_ROUTINES_XHBMV_H_
#define GPGPU_BLAS_ROUTINES_XHBMV_H_
...
class Xhbmv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xhbmv(const Queue &queue, Event* event, const std::string &name = "HBMV");
