...
#ifndef GPGPU_BLAS_ROUTINES_XHEMV_H_
#define GPGPU_BLAS_ROUTINES_XHEMV_H_
...
class Xhemv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xhemv(const Queue &queue, Event* event, const std::string &name = "HEMV");
