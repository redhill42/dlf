...
#ifndef GPGPU_BLAS_ROUTINES_XHPMV_H_
#define GPGPU_BLAS_ROUTINES_XHPMV_H_
...
class Xhpmv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xhpmv(const Queue &queue, Event* event, const std::string &name = "HPMV");
