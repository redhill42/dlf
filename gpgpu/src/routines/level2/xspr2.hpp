...
#ifndef GPGPU_BLAS_ROUTINES_XSPR2_H_
#define GPGPU_BLAS_ROUTINES_XSPR2_H_
...
class Xspr2: public Xher2<T> {
 public:
  ...
  // Constructor
  Xspr2(const Queue &queue, Event* event, const std::string &name = "SPR2");
