...
#ifndef GPGPU_BLAS_ROUTINES_XHER_H_
#define GPGPU_BLAS_ROUTINES_XHER_H_
...
class Xher: public Routine {
 public:
  ...
  // Constructor
  Xher(const Queue &queue, Event* event, const std::string &name = "HER");
