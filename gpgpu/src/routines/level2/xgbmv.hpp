...
#ifndef GPGPU_BLAS_ROUTINES_XGBMV_H_
#define GPGPU_BLAS_ROUTINES_XGBMV_H_
...
class Xgbmv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xgbmv(const Queue &queue, Event* event, const std::string &name = "GBMV");
