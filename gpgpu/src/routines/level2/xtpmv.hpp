...
#ifndef GPGPU_BLAS_ROUTINES_XTPMV_H_
#define GPGPU_BLAS_ROUTINES_XTPMV_H_
...
class Xtpmv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xtpmv(const Queue &queue, Event* event, const std::string &name = "TPMV");
