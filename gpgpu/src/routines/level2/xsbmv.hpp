...
#ifndef GPGPU_BLAS_ROUTINES_XSBMV_H_
#define GPGPU_BLAS_ROUTINES_XSBMV_H_
...
class Xsbmv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xsbmv(const Queue &queue, Event* event, const std::string &name = "SBMV");
