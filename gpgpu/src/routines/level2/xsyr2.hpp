...
#ifndef GPGPU_BLAS_ROUTINES_XSYR2_H_
#define GPGPU_BLAS_ROUTINES_XSYR2_H_
...
class Xsyr2: public Xher2<T> {
 public:
  ...
  // Constructor
  Xsyr2(const Queue &queue, Event* event, const std::string &name = "SYR2");
