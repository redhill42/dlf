...
#ifndef GPGPU_BLAS_ROUTINES_XSYMV_H_
#define GPGPU_BLAS_ROUTINES_XSYMV_H_
...
class Xsymv: public Xgemv<T> {
 public:
  ...
  // Constructor
  Xsymv(const Queue &queue, Event* event, const std::string &name = "SYMV");
