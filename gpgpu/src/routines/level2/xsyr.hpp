...
#ifndef GPGPU_BLAS_ROUTINES_XSYR_H_
#define GPGPU_BLAS_ROUTINES_XSYR_H_
...
class Xsyr: public Xher<T,T> {
 public:
  ...
  // Constructor
  Xsyr(const Queue &queue, Event* event, const std::string &name = "SYR");
