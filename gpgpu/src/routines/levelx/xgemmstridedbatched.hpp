...
#ifndef GPGPU_BLAS_ROUTINES_XGEMMSTRIDEDBATCHED_H_
#define GPGPU_BLAS_ROUTINES_XGEMMSTRIDEDBATCHED_H_
...
public:
  ...
  // Constructor
  XgemmStridedBatched(const Queue &queue, Event* event, const std::string &name = "GEMMSTRIDEDBATCHED");
