...
#ifndef GPGPU_BLAS_ROUTINES_XCOL2IM_H_
#define GPGPU_BLAS_ROUTINES_XCOL2IM_H_
...
class Xcol2im: public Routine {
 public:
  ...
  // Constructor
  Xcol2im(const Queue &queue, Event* event, const std::string &name = "COL2IM");
...
// GPGPU_BLAS_ROUTINES_XCOL2IM_H_
#endif
