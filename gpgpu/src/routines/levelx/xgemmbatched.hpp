...
#ifndef GPGPU_BLAS_ROUTINES_XGEMMBATCHED_H_
#define GPGPU_BLAS_ROUTINES_XGEMMBATCHED_H_
...
class XgemmBatched: public Routine {
 public:
  ...
  // Constructor
  XgemmBatched(const Queue &queue, Event* event, const std::string &name = "GEMMBATCHED");
...
// GPGPU_BLAS_ROUTINES_XGEMMBATCHED_H_
#endif
